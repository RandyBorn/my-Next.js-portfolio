export default function ProjectsPage() {
  return (
    <div className="max-w-md mx-auto space-y-6">
      {/* Erstes Projekt */}
      <div className="bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-purple-500/100 transition-shadow duration-700">
        <a
      ...
      {/* Zweites Projekt */}
      <div className="bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-purple-500/90 transition-shadow duration-300">
        <a
